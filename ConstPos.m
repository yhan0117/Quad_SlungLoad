...
% --------------------------------------Trajectory--------------------------------------%
% Constant position (hovering)
% WLOG, assume x y and z are at 0

% Constrained Equations of Motion
con_eqns = subs(int_ode, q(1:3), [0 0 0]);
...
save("Mats\ConstPos.mat")
disp("Numerical Solution Done")


%% --------------------------------------Animation--------------------------------------%
clear;clc;clf
load("Mats\ConstPos.mat")
plot(t_, U_*10^-3);
set(gcf,'WindowState','fullscreen')
xlabel("Time [t]")

ylabel("Thrust [N]")
title(sprintf('Total Thrust over 5 sec'), 'Interpreter', 'Latex');

exportgraphics(gcf, "Animation\ConstPos\input.jpeg")
...
% gif name
filename = "Animation\ConstPos\" + POV + ".jpeg";
delete(filename)
